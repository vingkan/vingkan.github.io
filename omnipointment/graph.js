function initHeatMapDisplay(heatmapObject){
  //UI configuration
  var itemSize = 18,
    cellSize = itemSize-1,
    width = 800,
...
/*      }
  d3.json(file,function(err,data){*/
    ...
    data.forEach(function(valueObj){
      ...
      var pmValue = valueObj['value']['free'];
    ...
    rect.filter(function(d){ return d.value['free']>0;})
      .append('title')
      .text(function(d){
        return monthDayFormat(d.date)+' '+d.value['free'];
      });
  ...
  function renderColor(){
    ...
    rect
      ...
      .attrTween('fill',function(d,i,a){
        ...
        return d3.interpolate(a,colorCalibration[colorIndex(d.value['free'])]);
      });
  }
